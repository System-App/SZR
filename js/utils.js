...
/**
 * Convert a Firestore Timestamp (or millis/Date) → local 'HH:MM'.
 * Used to render server-authoritative check-in/out times so a tampered
 * device clock can't fake the recorded time.
 */
