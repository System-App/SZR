  ...
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then((cache) => {
        ...
        // pre-cache the FRESHEST files from the network. Without it, a long
        // Cache-Control max-age on the server could cause us to re-cache
        // stale files even after bumping CACHE_NAME — defeating the update.
